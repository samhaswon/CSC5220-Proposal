...
% Maybe keep this one
% The final component will be \emph{PyTorch}. 
% It has been chosen as the machine learning framework for this project. 
% It is a common library that provides many tools aligned with our goals. 
% Having both of these options will provide some freedom for experimenting with model structure and hyperparameters.
